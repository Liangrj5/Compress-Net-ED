...
from model.prune import PruningModule, MaskedLinear

class HiddenNet_Compress(nn.Module):
    """
    Inserts a watermark into an image.
    """
    def __init__(self):
        super(HiddenNet_Compress, self).__init__()
        ...
        self.after_concat_layer = ConvBNRelu(img_conv_channels + 3 + self.Num_wm,
                                             img_conv_channels)
    ...
    def forward(self, img, wm):
        ...
        img_wm = torch.cat([wm, img, img_wm], dim=1)
